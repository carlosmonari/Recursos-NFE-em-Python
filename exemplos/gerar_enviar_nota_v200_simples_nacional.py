...
##Caso encoding do sistema não seja UTF8,
##Em Windows normalmente é ascii
if os.name==u'nt':
    reload(sys)
...
from nfe.pysped.nfe.manual_401.nfe_200 import NFe as NFe_200
from nfe.pysped.nfe.manual_401.nfe_200 import Det as Det_200
...
if __name__ == '__main__':
    ...
    #det.prod.xProd.valor    = u'DESCRICAO DO PRODUTO USADO PARA EMISSAO'
    ...
    resultados = nova_nfe.processar_nfe(xml_nfe=nfe.xml, cert=info_certificado['cert'], key=info_certificado['key'], versao=u'2.00', ambiente=2, estado=u'MG', tipo_contingencia=False)
    print("\nResultado:\n")
